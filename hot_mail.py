...
def main():
    ...
    CONFIG = {
    'credentials_path': 'D:\\GRN\\Excel\\Blinkit\\credentials.json',  # Path to your Google credentials JSON
    'gdrive_folder_id': '1pZnVxyPRJWaoYldxvWyXLFxQHbdckZfP',  # Optional: Google Drive folder ID to upload to
    'sender': 'purchaseorder@handsontrades.com',  # Email address to search from
    'search_term': 'GRN and reconciliation ',  # Keywords to search for
    'days_back': 30, # How many days to search
